...
function checkWhoWin() {
  if (combinationRow1() || combinationRow2()  || combinationRow3() ||
    combinationColumn1() || combinationColumn2() || combinationColumn3() ||
    combinationColumn3() || combinationDiagonal1() || combinationDiagonal2() ) {
      displayMessage('hey')
    } else if (round===9){
